if (Drupal.jsEnabled) {
  $(document).ready(function() {
     $('div.hosting-module_management-field-description').hide();
     hostingmodule_managementCheck();
     $('div.hosting-module_management-field input').change( hostingmodule_managementCheck );
  });

  hostingmodule_managementToggleOptions  = function() {
    // iterate through the visible options
    settings = Drupal.settings.hostingmodule_managementAvailableOptions;
    ...
    for (var key in settings) {
      ...
      desc_id = 'div#hosting-module_management-field-' + css_key + '-description';

      // generate an css id to retrieve the value, based on the field type.
      var id = 'div#hosting-module_management-field-' + css_key;
      if ($(id).hasClass('hosting-module_management-field-radios')) {
      ...
      else if ($(id).hasClass('hosting-module_management-field-textfield') || $(id).hasClass('hosting-module_management-field-textarea')) {
  ...
  hostingmodule_managementCheck = function() {
    var record = {}

     $('div.hosting-module_management-field').each( function() {
       // get the field name for this field.
       var field = $(this).attr('id').replace('hosting-module_management-field-', '').replace(/-/g,'_');

       // generate an css id to retrieve the value, based on the field type.
       var id = 'input[@name=' + field + ']';
       if ($(this).hasClass('hosting-module_management-field-radios')) {
         id = id + ':checked'
       }
    ...
    var resultOptions = function(data) {
      Drupal.settings.hostingmodule_managementAvailableOptions = data
      hostingmodule_managementToggleOptions();
    }
    $.post('/hosting/hosting_module_management_form_check', record, resultOptions, 'json');
  }
